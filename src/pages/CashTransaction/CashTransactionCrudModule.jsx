...
import CashTransactionDataTable from './CashTransactionDataTable';
...
function CashTransactionCrudModule({ config, createForm, updateForm, withUpload = false }) {
  const dispatch = useDispatch();
  ...
  return (
    ...
    >
      <CashTransactionDataTable config={config} />
      <DeleteModal config={config} />
    </CrudLayout>
  );
}

export default CashTransactionCrudModule;
